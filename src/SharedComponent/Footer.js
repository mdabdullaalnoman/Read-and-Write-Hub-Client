...
const Footer = () => {
	return (
     ...
     <div>
		 <div>
			 <h3 className="pb-6 text-white text-base font-Inter">QUICK LINKS</h3>
		 </div>
		 <hr />
		<div className="pt-4 font-Nanum">
		<div>Home</div>
		 <div>Blog</div>
		 <div>Styles</div>
		 <div>About</div>
    ...
    <div>
	      <div>
			 <h3 className="pb-6 text-white text-base font-Inter">ARCHIVES</h3>
		 </div>
		 <hr />
		 <div className="pt-4 font-Nanum">
    ...
    <div>
	<div>
			 <h3 className="pb-6 text-white text-base font-Inter">SOCIAL</h3>
		 </div>
		 <hr />
		 <div className="pt-4 font-Nanum">
		<div>Facebook</div>
    ...
    <div>
	<div>
			 <h3 className="pb-6 text-white text-base font-Inter">OUR NEWSLETTER</h3>
		 </div>
		 <hr />
		 <div className="pt-4">
			 <p className="font-Nanum">Blogging is a great way to show your talents and interests to prospective employers, while adding an edge to your resume. If you blog consistently it shows your dedication, passions and creativity – all of which are key attributes employers look for in job candidates.</p>
		 </div>

...
const PopularPosts = () => {
	return (
		<div>
			<div className="row gap-4 inline">
				<div className="col-eight tab-full mx-12 ">
					<h2 className="text-2xl font-semibold my-12 font-Libre">Popular Posts</h2>
				</div>
			...
			<div className="grid lg:grid-cols-3 gap-4 md:grid-cols-3 sm:grid-cols-1">
				<div className="flex flex-col ml-12">
					...
					<div className="flex flex-cols-2 gap-4">
						...
						<div>
							<h3 className=" text-base font-Inter hover:text-blue-800">Throwback To The Good Old Days.</h3>
							<small className="text-gray-500 font-Nanum">By <span className="text-black hover:text-blue-800">John Doe</span> on Dec 14, 2017</small>
						</div>
					...
					<div>
						<div className="flex flex-cols-2 gap-4">
							...
							<div>
								<h3 className=" text-base font-Inter hover:text-blue-800">Absolutely No Sugar Oatmeal Cookies.</h3>
								<small className="text-gray-500 font-Nanum">By <span className="text-black hover:text-blue-800">John Doe</span> on Dec 14, 2017</small>
							</div>
						</div>
					</div>
					<div>
						<div className="flex flex-cols-2 gap-4">
							...
							<div>
								<h3 className=" text-base font-Inter hover:text-blue-800">Key Benefits Of Family Photography.</h3>
								<small className="text-gray-500 font-Nanum">By <span className="text-black hover:text-blue-800">John Doe</span> on Dec 14, 2017</small>
							</div>
						</div>
					</div>
				...
				<div className="flex flex-col ml-12">
					<div>
						<div className="flex flex-cols-2 gap-4">
							...
							<div>
								<h3 className=" text-base font-Inter hover:text-blue-800">10 Interesting Facts About Caffeine.</h3>
								<small className="text-gray-500 font-Nanum">By <span className="text-black hover:text-blue-800">John Doe</span> on Dec 14, 2017</small>
							</div>
						</div>
					</div>
					<div>
						<div className="flex flex-cols-2 gap-4">
							...
							<div>
								<h3 className=" text-base font-Inter hover:text-blue-800">Visiting Theme Parks Improves Your Health.</h3>
								<small className="text-gray-500 font-Nanum">By <span className="text-black hover:text-blue-800">John Doe</span> on Dec 14, 2017</small>
							</div>
						</div>
					</div>
					<div>
						<div className="flex flex-cols-2 gap-4">
							...
							<div className="mb-20">
								<h3 className=" text-base font-Inter hover:text-blue-800">Healthy Mediterranean Salad Recipes</h3>
								<small className="text-gray-500 font-Nanum">By <span className="text-black hover:text-blue-800">John Doe</span> on Dec 14, 2017</small>
							</div>
						</div>
					</div>
				...
				<div>
				<div className="row1 gap-4 inline">
				<div className="col-eight tab-full mx-12">
					<h2 className="text-2xl font-semibold gapping font-Libre">About WriteHub</h2>
				 </div>
				</div>
					<div className="text-gray-500 mx-12 font-Nanum">
